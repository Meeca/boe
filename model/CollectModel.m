...
- (void)loadCache
{
    self.recommends = [HomeIndex readFromUserDefaults:@"CollectModel.recommends"];
}

- (void)saveCache
{
    [HomeIndex userDefaultsWrite:[self.recommends objectToString] forKey:@"CollectModel.recommends"];
}

- (void)clearCache
{
    [HomeIndex userDefaultsRemove:@"CollectModel.recommends"];
}
...
{
    [API_APP_PHP_INDEX_GZ_INDEX cancel];
    
    API_APP_PHP_INDEX_GZ_INDEX * api = [API_APP_PHP_INDEX_GZ_INDEX api];
    ...
    api.whenUpdate = ^
    {
        ...
        else
        {
            ...
            NSLog(@"----API_APP_PHP_INDEX_GZ_INDEX---");

...
@interface CircleMembersViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
NSString *path = @"/app.php/Circles/circle_members";
    ...
    {
        NSArray *dictArr = requestDic[@"info"];
        
        // 字典数组转换成模型数组
//        _squareItems = [JDFSquareItem mj_objectArrayWithKeyValuesArray:dictArr];
//        _squareItems = [JDFSquareItem yy_modelWithJSON:@"info"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JDFSquareCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];

...
@protocol FindSliderVCDelegate;
@interface FindSliderVC : UIView <UIScrollViewDelegate>
...
@property (nonatomic, weak) id<FindSliderVCDelegate> slideSwitchViewDelegate;
...
@protocol FindSliderVCDelegate <NSObject>
 ...
 * @result
 */
- (void)slideSwitchView:(FindSliderVC *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(FindSliderVC *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(FindSliderVC *)view didselectTab:(NSUInteger)number;

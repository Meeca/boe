...
@interface SliderViewController : UIView <UIScrollViewDelegate>
...
@property (nonatomic, weak) id<SliderViewControllerDelegate> slideSwitchViewDelegate;
 ...
 * @result
 */
- (void)slideSwitchView:(SliderViewController *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(SliderViewController *)view panRightEdge:(UIPanGestureRecognizer*) panParam;

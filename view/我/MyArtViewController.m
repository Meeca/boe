...
- (void)viewDidLoad {
    ...
    [collect registerClass:[ZuoPinCell class] forCellWithReuseIdentifier:@"myArtCell"];
...
ON_SIGNAL3(BaseModel, SHAREEQUIPMENTLIST, signal) {
    ...
    if (_dataArray.count>1) {
        ...
        if (_dataArray.count==1) {
            ...
            [baseModel app_php_Jpush_indexWithP_id:p_idsStr e_id:list.e_id type:@"2" pay_type:pay_type u_id:kUserId];
        } else {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZuoPinCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"myArtCell" forIndexPath:indexPath];
